...
contract Token is ERC20Burnable, Ownable {
    ...
    address public platformFeeAddress; // service fee wallet address
    ...
    constructor(
        ...
        maxWalletAmount = percents[3]==0 ? realSupply : realSupply * percents[3] / TAX_DIVISOR;
        maxTransactionAmount = percents[4]==0 ? realSupply : realSupply * percents[4] / TAX_DIVISOR;

        platformFeeAddress = addresses[2];
        ...
        _isExcludedFromFee[platformFeeAddress] = true;
    ...
    // function for set platformFeeAddress
    function setPlatformFeeAddress(address newAddress) external onlyOwner {
    ...
    function doSwap() internal swapping {
        ...
        if (platformFeeAmount > 0) {
            ...
            platformFeeAmount = 0;
            swapTokensForNative(_amount, platformFeeAddress);
        }
